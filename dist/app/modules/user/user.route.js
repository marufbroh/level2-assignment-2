...
router.get('/:userId/orders', user_controller_1.userController.getOrdersFromUser);
router.get('/:userId/orders/total-price', user_controller_1.userController.getTotalPriceOfOrdersFromUser);
